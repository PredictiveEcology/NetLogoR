...
* clear-turtles (ct): see NetLogoR dictionnary entry for clear-globals. If reassigning, `turtles <- noTurtles()` can be used to kill all the turtles in the agentset and replace it by an empty turtle agentset.
