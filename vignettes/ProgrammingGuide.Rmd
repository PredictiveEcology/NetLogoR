...
All these procedures need to be coded in the model, either using the `plot()` functions adapted to the `NetLogoR` classes for the world visualization, or using R functions and of different packages for any other figures.
